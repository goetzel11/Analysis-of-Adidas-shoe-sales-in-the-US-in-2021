# Analysis of Adidas shoe sales in the US in 2021

## Repository Outline
```
1. README.md - Penjelasan gambaran umum project
2. P0M1_Muhammad_Aldzahabi.ipynb - Notebook yang berisi pengolahan data dengan python, pengolahan data dengan metode statistika deskriptif dan inferensial, pembersihan data (dari data kotor menjadi data yang sudah bersih), visualisasi dari pengolahan data
3. Adidas_Shoe_Sales.csv - Berisi dataset yang masih kotor (raw dari kaggle)
